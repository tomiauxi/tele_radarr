...
func main() {
	...
	radarrConfig := starr.New(config.RadarrAPIKey, fmt.Sprintf("%v://%v:%v%v", config.RadarrProtocol, config.RadarrHostname, config.RadarrPort, config.RadarrBaseUrl, config.RadarrUsername, config.RadarrPassword), 0)
